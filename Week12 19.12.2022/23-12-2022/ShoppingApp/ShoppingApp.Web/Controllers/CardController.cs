    ...
    public class CardController : Controller
    {
        ...
        public async Task<IActionResult> Checkout(OrderDto orderDto)
        {
            if (ModelState.IsValid)
            {
                ...
                // 2) Eğer kart numarası geçrliyse ödemeyi al
                // 3) Ödeme başarılıysa orderi kaydet
                if (!CardNumberControl(orderDto.CardNumber))
                {
                    TempData["Message"] = Jobs.CreateMessage("Hata", "Kredi kartı numarası hatalı!", "danger");
                    return View(orderDto);
                }
        ...
        private bool CardNumberControl(string cardNumber)
        {
            #region aciklama
            /*
                1) cardNumber boşluk karakterlerinden temizlensin
                2) cardNumber uzunluk kontrolü
                3) Sayısal değer kontrolü
                4) Luhn Algoritmasını uygulamak için gerekenler yapılacak.
            */
            #endregion
            ...
            for (int i = 0; i < cardNumber.Length; i+=2)
            {
                ...
                int addedOddNumber = nextOvenNumber * 2;
        ...
        private Payment PaymentProcess(OrderDto orderDto)
        {
            ...
            options.ApiKey = "sandbox-1cCnzB4uCLPGCVXrTdrIxc6iEJpnlQlg";
            options.SecretKey = "sandbox-9E8TxF1Iai7P4FmMdldBUr0htgYWIpS2";
            ...
            CreatePaymentRequest request = new CreatePaymentRequest
            {
                ...
                Price = Convert.ToInt32(orderDto.CardDto.TotalPrice()).ToString(), // toplam tutar ile ödenecek tutar virgülüne kadar aynı olmalı, ondan dolayı virgül sonrasını kaldırdık fakat sonrasında virgüller noktaya çevrilebilir.
                ...
                Buyer = new Buyer
                {
                    ...
                    IdentityNumber = "7500300864791",
                    RegistrationAddress = "Barbaros Bulvarı, Yıldız İş Merkezi, K:3",
                    Ip = "35.34.112.78",
                    City = "Istanbul",
                    Country = "Turkey"
                },
                ShippingAddress = new Address
                {
                    ...
                    City = "İstanbul",
                    Country = "Türkiye",
                    Description = "Barbaros Bulvarı, Yıldız İş Merkezi, K:3"
                },
            ...
            foreach (var item in orderDto.CardDto.CardItems)
            {
                ...
                basketItem.Category1 = "Genel"; // Bu bize aslında cardDto içindeki productların category bilgilerini doldurmamız gerektiğini hatırlattı.
