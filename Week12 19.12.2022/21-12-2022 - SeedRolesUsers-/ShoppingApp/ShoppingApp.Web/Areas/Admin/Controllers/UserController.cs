    ...
    public class UserController : Controller
    {
        ...
        public async Task<IActionResult> Edit(UserAddDto userUpdateDto)
        {
            if (ModelState.IsValid)
            {
                ...
                await _userManager.AddToRolesAsync(user, userUpdateDto.SelectedRoles.Except(userRoles).ToList<string>()); // Önceden seçilen roller ile değişiklik yapılan roller arasındaki değişmeyeni çıkartır ki güncellemesin. Kısaca değişiklik yapılanı ekler.
        ...
        //Roller ve Kullanıcılar ile ilgili silme işlemlerini de tamamlayın.
    }
}
