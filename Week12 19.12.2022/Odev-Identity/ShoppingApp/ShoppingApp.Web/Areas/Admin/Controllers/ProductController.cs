    ...
    public class ProductController : Controller
    {
        ...
        public async Task<IActionResult> Create(ProductAddDto productAddDto)
        {
            if (ModelState.IsValid)
            {
                ...
                TempData["Message"] = Jobs.CreateMessage("Başarılı", "Ürün başarıyla eklendi.", "success");
        ...
        public async Task<IActionResult> Edit(ProductUpdateDto productUpdateDto, int[] selectedCategoryIds)
        {
            if (ModelState.IsValid)
            {
                ...
                TempData["Message"] = Jobs.CreateMessage("Bilgi", "Ürün başarıyla güncellendi", "warning");
                return RedirectToAction("Index");
            }
            var categories = await _categoryService.GetAllAsync();
        ...
        public async Task<IActionResult> Delete(int id)
        {
            ...
            return RedirectToAction("Index");
            TempData["Message"] = Jobs.CreateMessage("Bilgi", "Ürün silme işlemi gerçekleşti.", "warning");
        }
    }
}
