    ...
    public class CategoryController : Controller
    {
        ...
        public async Task<IActionResult> Create(CategoryAddDto categoryAddDto)
        {
            if (ModelState.IsValid)
            {
                ...
                TempData["Message"] = Jobs.CreateMessage("Başarılı", "Kategori başarıyla eklendi.", "success");
        ...
        public async Task<IActionResult> Edit(CategoryUpdateDto categoryUpdateDto)
        {
            if (ModelState.IsValid)
            {
                ...
                TempData["Message"] = Jobs.CreateMessage("Bilgi", "Kategori başarıyla güncellendi.", "warning");
                return RedirectToAction("Index");
        ...
        public async Task<IActionResult> Delete(int id)
        {
            ...
            TempData["Message"] = Jobs.CreateMessage("Bilgi", "Kategori silme işlemi gerçekleşti.", "warning");
            return RedirectToAction("Index");
        }
    }
}
