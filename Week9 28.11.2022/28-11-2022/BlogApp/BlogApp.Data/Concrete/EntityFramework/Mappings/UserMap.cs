...
namespace BlogApp.Data.Concrete.EntityFramework.Mappings
{
    public class UserMap : IEntityTypeConfiguration<User>
    {
        public void Configure(EntityTypeBuilder<User> builder)
        {
            ...
            builder.HasIndex(u=>u.Email).IsUnique(); // Unique olma özelliğini verir. Yani aynı email adresi ile ikinci bir kayıt yapılamaz.

            builder.Property(u => u.UserName)
                .IsRequired()
                .HasMaxLength(20);

            builder.HasIndex(u => u.UserName).IsUnique(); // Unique olma özelliğini verir. Yani aynı username ile ikinci bir kayıt yapılamaz.
            ...
            builder.HasData(
                new User
                {
                    ...
                    PasswordHash = Encoding.ASCII.GetBytes("200820e3227815ed1756a6b531e7e0d2") // qwe123 şifresinin hashlenmiş hali
                },
                new User
                {
                    Id = 2,
                    ...
                    PasswordHash = Encoding.ASCII.GetBytes("46f94c8de14fb36680850768ff1b7f2a") // 123qwe şifresinin hashlenmiş hali
                }
                );
        }
    }
