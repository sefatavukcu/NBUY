...
namespace BlogApp.Services.Concrete
{
    public class ArticleManager : IArticleService
    {
        ...
        public async Task<IResult> Add(ArticleAddDto articleAddDto, string createdByName)
        {
            ...
            //article.CreatedDate= DateTime.Now; // entities base de tanımlamamış olsaydık burada da böyle tanımlayabilirdik. Bunun ikinci bir yolu da profile içinden bu değeri vermek.
            article.UserId = 1; // userId şimdilik elle veriyoruz. login işlemlerini tamamladığımızda burayı değiştireceğiz.
        ...
        public async Task<IResult> Update(ArticleUpdateDto articleUpdateDto, string modifiedByName)
        {
            ...
            if (result!=null)
            {
                var article = _mapper.Map<Article>(articleUpdateDto); // Article profile kullanıyor.
