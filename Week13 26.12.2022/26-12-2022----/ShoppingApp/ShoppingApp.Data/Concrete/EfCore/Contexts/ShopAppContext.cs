...
namespace ShoppingApp.Data.Concrete.EfCore.Contexts
{
    public class ShopAppContext : IdentityDbContext<User, Role, string>
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.ApplyConfiguration(new ProductConfig()); // -----burası
            modelBuilder.ApplyConfiguration(new ProductCategoryConfig());
            modelBuilder.Entity <OrderItem>()
                .Property("Price")
                .HasColumnType("money"); // bunuda burda yapmamız grekmezdi OrderItem da tablonun içinde değişebiliridk
