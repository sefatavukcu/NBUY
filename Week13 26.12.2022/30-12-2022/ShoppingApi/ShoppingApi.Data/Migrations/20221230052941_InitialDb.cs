    ...
    public partial class InitialDb : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "472614db-47be-42de-a704-029a1e0e0c92", null, "User rolü", "User", "USER" },
                    { "9d446d2f-003f-406d-8cef-071e0bf3aade", null, "Admin rolü", "Admin", "ADMIN" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "0656944e-4058-4bf6-942a-0121d20e8ad9", 0, "Çek cd. Senet sk. Fatura ap.", "İstanbul", "c520caff-e98b-497e-a3e7-144c6d56b23d", new DateTime(1998, 5, 19, 0, 0, 0, 0, DateTimeKind.Unspecified), "admin@gmail.com", true, "Deniz", "Kadın", "Admin", false, null, "ADMIN@GMAIL.COM", "ADMIN", "AQAAAAIAAYagAAAAENcpdl59plBwmqeaTrF7p32wKOnHK5sXNhL9BcE6ZeUO37u0yLURigBTHQjs2EoLVQ==", "5555555555", false, "358fd72b-8831-4697-aeb9-d2ba49f6487a", false, "admin" },
                    { "c9c12e86-80a7-4685-be3a-e493694ea2be", 0, "Akasya cd. Orkide sk. Gül ap.", "İzmir", "73e09f62-f5ed-4a3c-a19a-279bf516cf18", new DateTime(1985, 10, 29, 0, 0, 0, 0, DateTimeKind.Unspecified), "user@gmail.com", true, "Kemal", "Erkek", "User", false, null, "USER@GMAIL.COM", "USER", "AQAAAAIAAYagAAAAEBELXlmeBTB5HrI8I2BTrIb2FNwjfSbHq96UVQW8aC5XoCYe/9eWUhiCzC5EnmC8pw==", "4444444444", false, "18656e3d-8e92-430a-9d9f-aa57b0f31275", false, "user" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "9d446d2f-003f-406d-8cef-071e0bf3aade", "0656944e-4058-4bf6-942a-0121d20e8ad9" },
                    { "472614db-47be-42de-a704-029a1e0e0c92", "c9c12e86-80a7-4685-be3a-e493694ea2be" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "0656944e-4058-4bf6-942a-0121d20e8ad9" },
                    { 2, "c9c12e86-80a7-4685-be3a-e493694ea2be" }
                });
