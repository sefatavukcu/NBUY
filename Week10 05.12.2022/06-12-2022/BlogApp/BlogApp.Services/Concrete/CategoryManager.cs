...
namespace BlogApp.Services.Concrete
{
    public class CategoryManager : ICategoryService
    {
        ...
        {
            var oldCategory = await _unitOfWork.Categories.GetAsync(c=>c.Id == categoryUpdateDto.Id); //önceden oluşturulan kategorilerin createdbyname createddate modifieddate gibi bilgilerini bununla aldık.
