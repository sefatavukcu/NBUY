    ...
    public class CategoryController : Controller
    {
        ...
        public async Task<IActionResult> Create(CategoryAddDto categoryAddDto)
        {
            if (ModelState.IsValid)
            {
                ...
                //return RedirectToAction(nameof(Index)); // Üstteki ile aynı anlamda
            }
            return View();
        }
        [HttpGet]
        ...
        public async Task<IActionResult> Edit(CategoryUpdateDto categoryUpdateDto)
        {
            ...
            return View(categoryUpdateDto); // eksik bir şey varsa her türlü geri gönderelim ki onları göstersin.
        }

        [HttpGet] // formdan veri gönderilmediği için postta çalışmaz. Get olması lazım.
