...
namespace ShoppingApp.Data.Concrete
{
    public class UnitOfWork : IUnitOfWork
    {
        ...
        public ICategoryRepository Categories => _categoryRepository = _categoryRepository ?? new EfCoreCategoryRepository(_context); // eğer varsa aynısını al ama _categoryRepository yoksa yenisini oluştur.
